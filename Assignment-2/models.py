...
from keras.layers import Dense, LSTM, BatchNormalization, Dropout, RepeatVector, TimeDistributed
...
class AELSTMMSModel:
    def __init__(self, input_size):
        ...
        self.history = None
        self.model = Sequential()
        self.model.add(LSTM(100, activation='relu', input_shape=(self.input_size, 1)))
